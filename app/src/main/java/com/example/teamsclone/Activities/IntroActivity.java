...
import com.example.teamsclone.Adapters.IntroViewPagerAdapter;
import com.example.teamsclone.R;
import com.example.teamsclone.models.ScreenItem;
...
public class IntroActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Personal Chat","Chat with your Friends in Personal Chat Rooms", R.drawable.friends));
        mList.add(new ScreenItem("Create Groups","Create Groups, Add Participants", R.drawable.groupcreation));
        mList.add(new ScreenItem("Group Discussions","Have Discussions in Groups, explore its exciting Features", R.drawable.discussion));
