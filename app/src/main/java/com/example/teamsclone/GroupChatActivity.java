...
public class GroupChatActivity extends AppCompatActivity {
    ...
    {
        dPic = findViewById(R.id.pic_group);
        gName = findViewById(R.id.name_group);
        SendMessageButton = findViewById(R.id.fab_chat_group);
        userMessageInput = (EditText) findViewById(R.id.egroup_message_chat);
    }
}
